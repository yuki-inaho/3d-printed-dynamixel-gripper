...
1. [作業書](../studies/low-profile-20260926/outputs/low-profile-250g/WORKDOC.md) が正本の写し。通常36/36項目完了、DoDはD1〜D5完了、**D6とD7が未チェック**。完成済みと誤認しない。
2. [人向け20ページマニュアル](../studies/low-profile-20260926/outputs/low-profile-250g/MANUAL.pdf) / [HTML](../studies/low-profile-20260926/outputs/low-profile-250g/MANUAL.html)、[比較REPORT](../studies/low-profile-20260926/outputs/low-profile-250g/REPORT.md)。19画像、実メニュー・失敗・修復を記載。
3. [最終レビュー](../studies/low-profile-20260926/outputs/low-profile-250g/final-review.md)、[API-USAGE](../studies/low-profile-20260926/outputs/low-profile-250g/API-USAGE.md)、[CONVERTER](../studies/low-profile-20260926/outputs/low-profile-250g/CONVERTER.md)、[URDF検証](../studies/low-profile-20260926/outputs/low-profile-250g/robot/validation.json)。
4. [スキル案内](../studies/low-profile-20260926/outputs/low-profile-250g/skills/ONSHAPE-WORKFLOW.md)。設計repo直下 `skills/` に4スキル13ソースを参照/agents込みで保存済み。
