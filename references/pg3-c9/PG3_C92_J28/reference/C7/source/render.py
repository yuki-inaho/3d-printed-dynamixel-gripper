...
def render(items,path,cam=(165,215,185),target=(0,12,12),up=(0,0,1),scale=85,perspective=False,size=(1500,1150),fov=45):
...
if __name__=='__main__':
    raise SystemExit('Use visuals.py to render the admitted 25..135 degree range.')
