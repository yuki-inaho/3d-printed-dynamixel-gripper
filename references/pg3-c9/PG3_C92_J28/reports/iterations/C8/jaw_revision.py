...
def carriage(p=P):
    ...
    return base.fuse(original,
                     base.box(SHOE_INNER_X, -6.8, 18, 21.7, 19.8, 23.8),
                     base.box(SHOE_INNER_X, -6.8, -21.7, -18, 19.8, 23.8))
...
def independent_jaw_requirements(d):
    ...
    shoe_probe = base.box(-11, 7, 18, 21.7, 19.8, 23.8)
