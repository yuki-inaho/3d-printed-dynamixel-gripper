...
## Lateral jaw and wrist camera prototype (2026-09-22)

Read `studies/gripper_camera_lateral/README_ja.md` for the source-preserving 90-degree gripper clocking and UVC28 mount. It uses the mixed-servo baseline, not the unaccepted all-XL430 assembly. Re-import the exported assembly, keep no-op STEP serialization controls, and never promote assumed camera/fastener envelopes to fabrication approval.
