...
## 横開きグリッパ＋手首カメラ（2026-09-22）

既存ジョーを90°組み替え、交換式UVC28カメラマウントを追加する検証用プロトタイプ。混在サーボ版が基準で、実機製作は未承認です。実装・組立案は [study README](skills/cad-reverse-parametric/studies/gripper_camera_lateral/README_ja.md)、検証結果は [設計レビュー](docs/gripper_camera_lateral_20260922.md)、作業記録は [diary](diary/2026-09-22_gripper-camera-lateral.md) を参照してください。
