...
Read [validation.md](references/validation.md) for the validation ladder and native UI operations. Read [api-and-export.md](references/api-and-export.md) when creating mates through REST or exporting URDF.
