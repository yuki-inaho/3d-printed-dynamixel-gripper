...
```text
/home/inaho-omen/Project/3d-printed-dynamixel-gripper/
...
```bash
sha256sum /home/inaho-omen/Project/3d-printed-dynamixel-gripper/outputs/camera-mount-id5-overhead-d405-r5/CAD/ID5_D405_mid_ASSEMBLY.step
```
...
```bash
cd /home/inaho-omen/Documents/Codex/2026-09-26/onshape/outputs
