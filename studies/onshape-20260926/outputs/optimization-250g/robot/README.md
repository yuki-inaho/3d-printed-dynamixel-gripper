...
```bash
rtk proxy uv run --project /home/inaho-omen/Project/3d-printed-dynamixel-gripper --no-sync python outputs/optimization-250g/robot/validate_robot.py
rtk proxy uv run --project /home/inaho-omen/Project/3d-printed-dynamixel-gripper --no-sync python outputs/optimization-250g/robot/pg3_states.py 90
```
